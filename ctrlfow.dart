/*Create a Dart program that prompts the user for a number and then prints a message to the console based on 
...
void main(){
  ...
  int? num = int.parse(stdin.readLineSync()!); // Here ? and ! are for null safetyk
